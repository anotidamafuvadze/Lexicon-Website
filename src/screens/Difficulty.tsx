...
/**
 * Difficulty
 * - Allows the player to choose a difficulty mode
 * - Updates theme, generates a new word, and starts a new game
 */
function Difficulty(): React.JSX.Element {
  ...
  return (
    <div>
      ...
      <div
        className="difficulty-button-group"
        style={{ backgroundImage: `url(${backgroundImage})` }}
      >
        <div className="difficulty-text-column">
          <button
            className="difficulty-button easy-button bounce-in"
            title="Easy Button"
            onClick={() => handlePress("easy")}
          >
            <img
              src={easyLabel}
              alt="Easy Label"
          ...
          <button
            className="difficulty-button normal-button bounce-in"
            title="Normal Button"
            onClick={() => handlePress("normal")}
          >
            <img
              src={normalLabel}
              alt="Normal Label"
          ...
          <button
            className="difficulty-button hard-button bounce-in"
            title="Hard Button"
            onClick={() => handlePress("hard")}
          >
            <img
              src={hardLabel}
              alt="Hard Label"
